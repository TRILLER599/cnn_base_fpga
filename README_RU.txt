...
После того, как будет реализован механизм "внимания", придёт время для настоящей 
оптимизации.        
...
и контроля корректности FPGA-алгоритма.
    ...
    Я НЕ профессиональный программист, а FPGA-разработчик, поэтому не обессудьте))
...
Обучение 1 эпохи занимает около 15 минут.
...
reti_neurali_base_0929.sv (     - файл верхнего уровня нейросети
    Генерируется из псевдо-С++ исходников собственным вариантом HLS, 
    поэтому читаемость и воспринимаемость кода не на высоком уровне.
);
